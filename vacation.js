    ...
    if (type === "Students") {
        ...
        if (number >= 100) {
            switch (day) {
                ...
                case "Sunday": totalPrice = (number - 10) * 16.00; break;
            }
        } else {
            switch (day) {
                case "Friday": totalPrice = number * 10.90; break;
                case "Saturday": totalPrice = number * 15.60; break;
                case "Sunday": totalPrice = number * 16.00; break;
            }
        }
        ...
        switch (day) {
            case "Friday": totalPrice = number * 15.00; break;
            case "Saturday": totalPrice = number * 20.00; break;
